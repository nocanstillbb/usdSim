...
Popup {
    ...
    contentItem: ColumnLayout {
        ...
        RowLayout {
            spacing: 8
            Label { text: "Name:"; color: AppStyle.textPrimary; font.family: AppStyle.fontFamily; font.pixelSize: AppStyle.fontSize; Layout.preferredWidth: 80 }
            TextField {
                id: newAttrName
                text: "new_attr"
        ...
        RowLayout {
            spacing: 8
            Label { text: "Type:"; color: AppStyle.textPrimary; font.family: AppStyle.fontFamily; font.pixelSize: AppStyle.fontSize; Layout.preferredWidth: 80 }
            ComboBox {
                id: newAttrType
                Layout.fillWidth: true
                ...
                contentItem: Text {
                    leftPadding: 6
                    text: newAttrType.displayText; font.family: AppStyle.fontFamily; font.pixelSize: AppStyle.fontSize
        ...
        RowLayout {
            spacing: 8
            Label { text: "Custom:"; color: AppStyle.textPrimary; font.family: AppStyle.fontFamily; font.pixelSize: AppStyle.fontSize; Layout.preferredWidth: 80 }
            CheckBox {
                ...
                indicator: Rectangle {
                    ...
                    Text { anchors.centerIn: parent; text: newAttrCustom.checked ? "\u2713" : ""; color: AppStyle.textWhite; font.family: AppStyle.fontFamily; font.pixelSize: AppStyle.fontSizeSmall }
                }
        ...
        RowLayout {
            spacing: 8
            Label { text: "Variability:"; color: AppStyle.textPrimary; font.family: AppStyle.fontFamily; font.pixelSize: AppStyle.fontSize; Layout.preferredWidth: 80 }
            ComboBox {
                ...
                contentItem: Text {
                    leftPadding: 6
                    text: newAttrVariability.displayText; font.family: AppStyle.fontFamily; font.pixelSize: AppStyle.fontSize
                    color: AppStyle.textBright; verticalAlignment: Text.AlignVCenter
                }
        ...
        RowLayout {
            ...
            Rectangle {
                ...
                Text { id: cancelBtnText; anchors.centerIn: parent; text: "Cancel"; color: AppStyle.textPrimary; font.family: AppStyle.fontFamily; font.pixelSize: AppStyle.fontSize }
            ...
            Rectangle {
                ...
                Text { id: addBtnText; anchors.centerIn: parent; text: "Add"; color: AppStyle.textWhite; font.family: AppStyle.fontFamily; font.pixelSize: AppStyle.fontSize }
